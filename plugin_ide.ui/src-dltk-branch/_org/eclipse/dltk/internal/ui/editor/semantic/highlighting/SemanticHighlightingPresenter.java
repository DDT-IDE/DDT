...
public class SemanticHighlightingPresenter implements
	 ...
	 *         given offset
	 */
	protected int computeIndexAfterOffset(List<? extends Position> positions,
			int offset) {
		int i = -1;
	 ...
	 *         than the given offset
	 */
	protected int computeIndexAtOffset(List<? extends Position> positions,
			int offset) {
		int i = -1;
		int j = positions.size();
		while (j - i > 1) {
	 ...
	 */
	protected Object getLockObject(IDocument document) {
	 ...
	 * @param highlighting
	 */
	protected void addPositionFromUI(int offset, int length, HighlightingStyle highlighting) {
