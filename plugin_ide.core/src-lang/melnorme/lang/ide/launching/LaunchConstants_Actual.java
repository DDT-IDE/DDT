...
public interface LaunchConstants_Actual {
	...
	public static final String ATTR_PROGRAM_PATH = ScriptLaunchConfigurationConstants.ATTR_MAIN_SCRIPT_NAME;
	public static final String ATTR_PROGRAM_ARGUMENTS = ScriptLaunchConfigurationConstants.ATTR_SCRIPT_ARGUMENTS;
