...
,}
▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂ various error cases
module#{, ,#@NL}#error(EXP_ID)#@SEMICOLON_OR_NO#comment(EOF):
▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂
module#{ ,   }foo.bar.#error(EXP_ID)#@SEMICOLON_OR_NO#comment(EOF):
▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂
module#{ ,   }foo.#error(EXP_ID)#@SEMICOLON_OR_NO#comment(EOF):
