...
public interface DeeModelConstants {
	...
	public static final int MODIFIERS_ARCHETYPE_MASK = 0x7 << Modifiers.USER_MODIFIER;
	public static final int MODIFIERS_AFTER_ARCHETYPE = Modifiers.USER_MODIFIER + 3;
	
	public static final int FLAG_TEMPLATED = 1 << MODIFIERS_AFTER_ARCHETYPE; // Not used yet
